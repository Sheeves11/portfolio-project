    ...
    ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓            <u><a href="instagram.com/pebbleandbraid" target="_blank">instagram.com/pebbleandbraid}</a></u>
      ▓▓▓   ▐▓▓   ▓▓   ▓▓▓   ▓▓▀             <u><a href="https://github.com/${config.social.github}" target="_blank">github.com/${config.social.github}</a></u> 
        ▀▓▓▄▄ ▀▓▓▄▓▓▄▓▓▓▄▄▓▓▀               
            ▀▓▓▓▓▓▓▓▓▓▓▓▀▀                   ART & DESIGN                
                                            -----------          
                                             <u><a href="https://muckrack.com/mia-quain/portfolio" target="_blank">muckrack writing portfolio</a></u>
                                             <u><a href="https://www.behance.net/sheeves11" target="_blank">behance visual art portfolio</a></u>                                                                             
`;
  }
};
